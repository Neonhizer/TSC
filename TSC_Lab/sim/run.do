...
##transcript file transcript_victor
...
# Load project
  eval vsim -novopt -quiet -nocoverage +notimingchecks +nowarnTSCALE -GWR_NR=$1 -GRD_NR=$2 -GWR_ORDER=$3 -GRR_ORDER=$4 -Gseed_nou=$5  -sva top
