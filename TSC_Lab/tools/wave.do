...
add wave -noupdate /top/test/RR_ORDER
add wave -noupdate /top/test/WR_NR
add wave -noupdate /top/test/WR_ORDER
add wave -noupdate /top/test/clk
add wave -noupdate /top/test/contor1
add wave -noupdate /top/test/contor2
...
add wave -noupdate /top/test/rezultatdenoi
...
update
WaveRestoreZoom {386 ns} {1386 ns}
